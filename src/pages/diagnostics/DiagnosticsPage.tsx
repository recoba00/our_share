...
const smokeChecklistItems = [
  ...
  "다른 계정이 초대 코드로 크루에 참여한다",
  "활성 A크루에서 B크루를 추가해도 A크루가 유지된다",
  "크루 전환에서 내 크루와 참여 크루 탭이 구분된다",
  "멤버로 크루를 나가면 위치·접속상태·기기상태가 정리된다",
  "크루장으로 크루를 삭제하면 멤버 runtime 데이터가 정리된다",
  "크루 멤버 목록이 표시된다",
  "OWNER가 멤버 역할을 변경할 수 있다",
  "OWNER가 다른 크루 멤버를 삭제할 수 있다",
  "현재 위치 공유가 권한 허용 후 성공한다",
  "멤버 위치 카드가 표시된다",
  "빠른 메시지가 크루 채팅방으로 전송된다",
  "일반 메모를 생성할 수 있다",
  "메모를 삭제할 수 있다",
