...
- [ ] 이용자 연령 기준과 미성년자·법정대리인 동의 절차 확정
- [ ] 개인정보 처리방침·위치정보 이용약관 법률 검토
- [ ] 실제 보유기간·파기 절차·개인정보 보호책임자 정보 확정
- [x] 공지사항을 Firestore 운영자 도구에서 관리

## Backoffice

- [x] 운영 계정 UID 기반 관리자 접근 가드
- [x] 공지 작성·수정·게시·삭제
- [x] 일반 사용자의 게시 공지 실시간 조회
- [x] 비공개 사용자 정보와 공개 프로필 컬렉션 분리
- [x] 기존 사용자 공개 프로필 자동 backfill
- [x] 사용자·크루 운영 현황 대시보드
- [x] 서버 집계 기반 운영 지표와 최근 데이터 제한 조회
- [x] 사용자·크루 디렉터리 25개 단위 커서 페이지네이션
- [x] 사용자명·크루명 접두어 검색과 쿼리 권한 회귀 테스트
- [x] 신고 접수·운영자 처리·이용 제한 관리
- [x] 신고 대상 사용자·채팅 메시지에서 바로 신고하는 문맥형 진입점
- [x] 운영 작업 감사 로그와 관리자 역할 세분화
- [ ] 감사 로그 검색·기간 필터와 CSV 내보내기
